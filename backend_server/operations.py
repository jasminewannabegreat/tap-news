...
# USER_NEWS_TIME_OUT_IN_SECONDS = 60 #60 is for test, use 1 hour for actually use
# NEWS_TABLE_NAME = "news"
# redis_client = redis.StrictRedis(REDIS_HOST, REDIS_PORT, db=0)

# LOG_CLICKS_TASK_QUEUE_URL = "amqp://fumghqwa:xW-752vQpnfpDzyP-QKO6ti4nndYyLpb@donkey.rmq.cloudamqp.com/fumghqwa"
...
#         slice_news_digests = news_digest[begin_index:end_index]

#         db = mongodb_client.get_db()

#         sliced_news = list(db[NEWS_TABLE_NAME].find({'digest':{'$in':slice_news_digests}}))
